...
hoistedDependencies:
  ...
  /@mistjs/eslint-config-basic/0.18.8(@typescript-eslint/parser@5.62.0)(eslint@9.8.0):
    '@mistjs/eslint-config-basic': public
  /@mistjs/eslint-config-ts/0.1.0(eslint@9.8.0)(typescript@5.5.4):
    '@mistjs/eslint-config-ts': public
  /@mistjs/eslint-config-vue/0.1.0(eslint@9.8.0)(typescript@5.5.4):
    '@mistjs/eslint-config-vue': public
  /@mistjs/tsconfig/1.1.1:
    '@mistjs/tsconfig': private
  ...
  /@typescript-eslint/eslint-plugin/5.62.0(@typescript-eslint/parser@5.62.0)(eslint@9.8.0)(typescript@5.5.4):
    '@typescript-eslint/eslint-plugin': public
  /@typescript-eslint/parser/5.62.0(eslint@9.8.0)(typescript@5.5.4):
    '@typescript-eslint/parser': public
  /@typescript-eslint/scope-manager/5.62.0:
    '@typescript-eslint/scope-manager': public
  /@typescript-eslint/type-utils/5.62.0(eslint@9.8.0)(typescript@5.5.4):
  ...
  /@vue/eslint-config-prettier/8.0.0(eslint@9.8.0)(prettier@3.3.3):
  ...
  /core-js/3.38.0:
    core-js: private
  /cosmiconfig-typescript-loader/5.0.0(@types/node@22.2.0)(cosmiconfig@9.0.0)(typescript@5.5.4):
  ...
  /eslint-config-prettier/8.10.0(eslint@9.8.0):
    eslint-config-prettier: public
  /eslint-config-standard/17.0.0-1(eslint-plugin-import@2.29.1)(eslint-plugin-n@14.0.0)(eslint-plugin-promise@6.6.0)(eslint@9.8.0):
    eslint-config-standard: public
  /eslint-import-resolver-node/0.3.9:
    eslint-import-resolver-node: public
  /eslint-module-utils/2.8.1(@typescript-eslint/parser@5.62.0)(eslint-import-resolver-node@0.3.9)(eslint@9.8.0):
    eslint-module-utils: public
  /eslint-plugin-es/4.1.0(eslint@9.8.0):
  ...
  /eslint-plugin-import/2.29.1(@typescript-eslint/parser@5.62.0)(eslint@9.8.0):
    eslint-plugin-import: public
  /eslint-plugin-jsonc/2.16.0(eslint@9.8.0):
    eslint-plugin-jsonc: public
  /eslint-plugin-markdown/2.2.1(eslint@9.8.0):
    eslint-plugin-markdown: public
  /eslint-plugin-n/14.0.0(eslint@9.8.0):
    eslint-plugin-n: public
  /eslint-plugin-prettier/5.2.1(eslint-config-prettier@8.10.0)(eslint@9.8.0)(prettier@3.3.3):
    eslint-plugin-prettier: public
  /eslint-plugin-promise/6.6.0(eslint@9.8.0):
    eslint-plugin-promise: public
  /eslint-plugin-unicorn/41.0.1(eslint@9.8.0):
    eslint-plugin-unicorn: public
  /eslint-plugin-vue/9.27.0(eslint@9.8.0):
    eslint-plugin-vue: public
  /eslint-plugin-yml/0.14.0(eslint@9.8.0):
...
pendingBuilds: []
prunedAt: Sat, 10 Aug 2024 10:57:54 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
virtualStoreDir: E:\前端\kawa-tiny-vue\node_modules\.pnpm
